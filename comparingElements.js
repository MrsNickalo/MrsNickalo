...
for(var arrayPosition = 0; arrayPosition < testArray.length-1; arrayPosition++)
{
	...
	console.log("Testing " + currentElement + " and " + nextElement + "(less than or equal): " + (currentElement <= nextElement));
	console.log("Testing " + currentElement + " and " + nextElement + "(equal): " + (currentElement == nextElement));
	console.log("Testing " + currentElement + " and " + nextElement + "(strictly equal): " + (currentElement === nextElement));
